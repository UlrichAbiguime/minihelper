...
public class CustomHttpClient {
	...
	public static JSONObject httpGet(String url, Bundle params) throws JSONException, HttpRequstError {
	 ...
	 */
	public static JSONObject getContent(String url) throws JSONException, HttpRequstError {
		...
		try {
			...
			sb = null;
			throw new HttpRequstError("协议错误！", url);
		} catch (IOException e) {
			sb = null;
			throw new HttpRequstError("无法链接服务！", url);
		}
	 ...
	 * @throws HttpRequstError
	 */
	public static JSONObject post(String url, Bundle params) throws JSONException, HttpRequstError {
		StringBuilder sb = new StringBuilder();
		HttpClient httpClient = CustomHttpClient.getHttpClient();
		...
		try {
			...
			sb = null;
			throw new HttpRequstError("URL解析错误！", url);
		} catch (ClientProtocolException e) {
			sb = null;
			throw new HttpRequstError("协议错误！", url);
		} catch (IOException e) {
	 ...
	 * @throws HttpRequstError
	 */
	public static JSONObject getContent(String url,boolean isCookie) throws JSONException, HttpRequstError {
		StringBuilder sb = new StringBuilder();
	 ...
	 * @throws HttpRequstError
	 */
	public static JSONObject post(String url, Bundle params, boolean isCookie) throws JSONException, HttpRequstError {
		StringBuilder sb = new StringBuilder();
		HttpClient httpClient = CustomHttpClient.getHttpClient();
		HttpPost httpPost = new HttpPost(url);
		try {
	...
	public static String build_api(String api, Bundle params) {
		...
		/*if (!api.equals(ClientApi.m_account_login)) { // 当接口不为登录的时候需要验证
