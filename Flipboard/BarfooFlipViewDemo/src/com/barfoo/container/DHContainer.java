/**
 * DHContainer(为AFormateStyle的横屏版式)
...
public class DHContainer extends AContainer{

	public DHContainer(Context context) {
		super(context);
		
	}
	public DHContainer(Context context, AttributeSet attrs,JSONObject json) {
	...
	public void buildView(JSONObject json) {
		...
		try {
			if (Util.isJsonNull(json, "titleimage")) {
				ViewUtil.setViewWidHeight(ll_image, itemviewW, itemviewH, 0.38, 0.64);
