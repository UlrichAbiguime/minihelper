...
public class CContainerFormate extends LinearLayout implements IContainer {
	...
	public CContainerFormate(Context context) {
		super(context);
	}

	public CContainerFormate(Context context, AttributeSet attrs,
			JSONObject json) {
		super(context, attrs);
		mContext = context;
		// LayoutInflater
		// layoutInflater=(LayoutInflater)mContext.getSystemService(Context.LAYOUT_INFLATER_SERVICE);
		// view = layoutInflater.inflate(R.layout.containeritema, null);
		LayoutInflater.from(mContext).inflate(R.layout.containeritemc, this,true);
		buildView(json);
	}
